...
res.render('index', { title: 'Abiotic App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Abiotic App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Abiotic App Login', user : req.user });
  });
